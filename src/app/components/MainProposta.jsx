...
function MainProposta() {
  return (
    <>
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-center md:justify-between px-4 py-8">
            <div className="md:w-1/2">
                {/* Conteúdo da primeira coluna */}
                <h1 className="text-center pt-8 text-5xl font-bold  text-slate-800">A proposta de trabalho</h1>
